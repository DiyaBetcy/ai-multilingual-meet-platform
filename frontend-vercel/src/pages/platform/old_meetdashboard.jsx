...
useEffect(() => {
  ...
  try {
    // If mic stream does not exist ΓåÆ request mic access
...
const sendMessage = (text) => {
  ...
  // Γ£à increase unread only if chat is closed
  if (!showChat) {
...
{screenWarning && (
  <div className="screen-warning-popup">
    <div className="popup-content">
      <p>
        ΓÜá <strong>Entire Screen sharing is not supported.</strong><br />
